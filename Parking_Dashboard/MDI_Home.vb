...
Public Class MDI_Home
    ...
    Private Sub MDI_Home_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim f As New dashboard
        f.MdiParent = Me
        f.Show()
    End Sub
    ...
    Private Sub MembersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MembersToolStripMenuItem.Click
        Dim f As New members
        f.MdiParent = Me
        f.Show()
    End Sub

    Private Sub ParkingInfoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ParkingInfoToolStripMenuItem.Click
        Dim f As New Parking
        f.MdiParent = Me
        f.Show()
    End Sub
End Class
